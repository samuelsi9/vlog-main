...
class _ChoiceAddressState extends State<ChoiceAddress> {
  ...
  Future<void> _loadAddresses() async {
    ...
    try {
      ...
      setState(() {
        ...
        // ✅ Fix: always pre-select default or first address
        // regardless of fromCheckout
        for (final a in list) {
          if (a.isDefault) {
            _selectedId = a.id;
            break;
  ...
  Widget _buildAddressCard(DeliveryAddressModel a, bool isSelected) {
    return Stack(
      ...
      children: [
        GestureDetector(
          ...
          child: Card(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: BorderSide(
                color: isSelected ? _redPrimary : Colors.grey[200]!, // ✅ uses isSelected
        ...
        if (isSelected) // ✅ uses isSelected not a.isDefault
          Positioned(
            top: 10,
            right: 10,
  ...
  Future<void> _onUseAddress(DeliveryAddressModel a) async {
    if (a.id == _selectedId) return; // already selected
                    ...
                    : _addresses.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              // ✅ Fix: use a.id == _selectedId instead of a.isDefault
