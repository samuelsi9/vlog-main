...
class _CategoryItemsState extends State<CategoryItems> {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredItems = _items.where((item) {
          ...
          // ✅ Starts with (your main request)
          if (name.startsWith(query) || description.startsWith(query)) {
            return true;
          }

          // ✅ Bonus: Also show if contains (after typing 3+ characters)
          if (query.length >= 3) {
  ...
  // Keep your existing _buildImage method unchanged
  Widget _buildImage(String imageUrl, {double? height, double? width}) {
    ...
    final isNetworkImage = trimmedUrl.startsWith('http') || trimmedUrl.contains('://');
    ...
    if (isNetworkImage) {
      return Image.network(
        ...
        errorBuilder: (_, __, ___) => _placeholderImage(height, width),
      );
    } else {
      return Image.asset(
        trimmedUrl,
  ...
  Widget build(BuildContext context) {
    if (_isLoading) {
      return Scaffold(
        ...
        body: const Center(child: CircularProgressIndicator(color: _primaryRed)),
      );
    }
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('Error loading products', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              const Text('Failed to fetch products for this category'),
    ...
    final subList = subCategories.where((sub) => sub.categoryId == categoryId).toList();
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Subcategories Section (unchanged)
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [BoxShadow(color: Colors.grey.shade400, blurRadius: 6, offset: const Offset(0, 3))],
                                    ),
                                    child: ClipOval(
                                      child: Image.asset(sub.image, fit: BoxFit.cover),
                                    ),
                                  ),
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text(
                            _searchController.text.isEmpty ? "No products in this category" : "No matching products",
                  ...
                  : Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final product = (widget.categoryId != null && originalIndex < _products.length)
                                    ...
                                    child: Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: _buildImage(item.image, width: double.infinity),
                                        ),
                                        if (productId != null)
                                          Positioned(
                                            top: 8,
                                                ...
                                                return InkWell(
                                                  onTap: () async {
                                                    try {
                                                      ...
                                                      if (mounted) {
                                                        ScaffoldMessenger.of(context).showSnackBar(
                                                          SnackBar(content: Text('Wishlist: ${e.toString()}'), backgroundColor: Colors.red),
                                                        );
                                                      }
                                                    }
                                                  },
