...
class _RegisterPageState extends State<RegisterPage>
  ...
  // ── Loading State (Same as LoginPage) ─────────────────────────────────────
  ...
  // ── Loading Helper ────────────────────────────────────────────────────────
  void _setLoading(bool value, {String message = 'Creating account…'}) {
    if (!mounted) return;
    setState(() {
      _isLoading = value;
  ...
  Future<void> _signUpWithGoogle() async {
    _setLoading(true, message: 'Connecting with Google…');
  ...
  Future<void> _signUpWithApple() async {
    _setLoading(true, message: 'Connecting with Apple…');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(  // ← Only change: wrapped in Stack for overlay
        children: [
          ...
          // ── Loading Overlay (Exactly like LoginPage) ───────────────────────
          if (_isLoading)
            Positioned.fill(
...
// Your social button remains exactly the same
...
//                           ),
//                           const SizedBox(height: 14),
//                           Text('This is optional', style: TextStyle(color: _lightGrey, fontSize: 12),),
//                           IntlPhoneField(
//                             controller: phoneController,
//                             decoration: _inputDecoration('Phone Number'),
//                             initialCountryCode: 'US',
...
//                             },
//                             onSaved: (phone) {
//                               if (phone != null) _completePhoneNumber = phone.completeNumber ?? '555';
//                             },
//                             //old version of check phone number
//                             // validator: (value) {
